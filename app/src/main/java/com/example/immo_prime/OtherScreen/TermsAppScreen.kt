...
fun TermsAppScreen(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Row(modifier = Modifier
            ...
            Text(text = "Terms & Condition", fontSize = 20.sp, textAlign = TextAlign.Center, fontWeight = FontWeight.SemiBold,modifier = Modifier
                .fillMaxWidth()
                .padding(end = 16.dp))
        }
...
fun TermsAppScreenPreview(){
    TermsAppScreen(navController = rememberNavController())
}